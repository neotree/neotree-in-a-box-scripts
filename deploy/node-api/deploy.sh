...
log_component "Starting Neotree Node API deployment"
...
if confirm_advanced_setup "Node API" "email server variables, nginx reverse proxy, domain or public IP setup, and optional TLS certificate configuration"; then
